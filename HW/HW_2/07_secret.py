...
massage = []
massage.append(secret_message[0][3])
massage.append(secret_message[1][9:13])
massage.append(secret_message[2][5:15:2])
massage.append(secret_message[3][-20:-26:-1])
massage.append(secret_message[4][-12:-17:-1])

print(f"Секретное сообщение -  {massage}")