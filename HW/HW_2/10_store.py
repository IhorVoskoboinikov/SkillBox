...
print('Лампа -', lamps_quantity, 'шт, стоимость', lamps_cost, 'грн')
...
table_quantity = table_item['quantity'] + table_item_1['quantity']
table_price = table_item['price'] + table_item_1['price']
table_cost = table_quantity * table_price

print(f"Столы - {table_quantity} шт, стоимость - {table_cost} грн")
# ===================================================='Диван'==================================
...
chair_quantitys = chair_item['quantity'] + chair_item_1['quantity'] + chair_item_2['quantity']
...
print(f"Стулья - {chair_quantitys} шт, стоимость - {chair_cost} грн")
